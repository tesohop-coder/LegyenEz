...
const translations = {
  ...
  de: {
    ...
    select_script_label: 'Skript auswählen',
    save_settings: 'Einstellungen Speichern',
    voice_selection: 'Stimmenauswahl',
    popular_voices: 'Beliebte Stimmen',
    custom_voice_id: 'Benutzerdefinierte Voice-ID',
    enter_voice_id: 'Benutzerdefinierte Voice-ID (ElevenLabs)',
    voice_id_hint: 'Finden Sie die Voice-ID im ElevenLabs-Dashboard',
    speed: 'Geschwindigkeit',
    speed_hint: '0.25x (sehr langsam) - 2.0x (sehr schnell)',
    broll_and_music: 'B-Roll und Musik',
    broll_search_placeholder: 'z.B.: faith prayer spiritual (optional)',
    background_music_placeholder: 'https://example.com/music.mp3',
    generate_video: 'Videogenerierung Starten',
  ...
  en: {
    ...
    enter_voice_id: 'Custom Voice ID (ElevenLabs)',
    voice_id_hint: 'Find Voice ID in ElevenLabs dashboard',
    speed: 'Speed',
    speed_hint: '0.25x (very slow) - 2.0x (very fast)',
    broll_and_music: 'B-roll & Music',
    broll_search_placeholder: 'e.g.: faith prayer spiritual (optional)',
    background_music_placeholder: 'https://example.com/music.mp3',
  ...
  pl: {
    ...
    select_script_label: 'Wybierz skrypt',
    save_settings: 'Zapisz ustawienia',
    voice_selection: 'Wybór głosu',
    popular_voices: 'Popularne głosy',
    custom_voice_id: 'Niestandardowy Voice ID',
    enter_voice_id: 'Niestandardowy Voice ID (ElevenLabs)',
    voice_id_hint: 'Znajdź Voice ID w panelu ElevenLabs',
    speed: 'Prędkość',
    speed_hint: '0.25x (bardzo wolno) - 2.0x (bardzo szybko)',
    broll_and_music: 'B-roll i muzyka',
    broll_search_placeholder: 'np.: wiara modlitwa duchowość (opcjonalnie)',
    background_music_placeholder: 'https://example.com/music.mp3',
    generate_video: 'Rozpocznij generowanie wideo',
    download: 'Pobierz',
    completed: 'Gotowe',
    failed: 'Błąd',
    queued: 'W kolejce',
  ...
  nl: {
    ...
    select_script_label: 'Selecteer script',
    save_settings: 'Instellingen opslaan',
    voice_selection: 'Stemselectie',
    popular_voices: 'Populaire stemmen',
    custom_voice_id: 'Aangepaste Voice ID',
    enter_voice_id: 'Aangepaste Voice ID (ElevenLabs)',
    voice_id_hint: 'Vind Voice ID in ElevenLabs dashboard',
    speed: 'Snelheid',
    speed_hint: '0.25x (zeer langzaam) - 2.0x (zeer snel)',
    broll_and_music: 'B-roll & muziek',
    broll_search_placeholder: 'bijv.: geloof gebed spiritueel (optioneel)',
    background_music_placeholder: 'https://example.com/music.mp3',
    generate_video: 'Start videogeneratie',
    download: 'Download',
    completed: 'Voltooid',
    failed: 'Mislukt',
    queued: 'In wachtrij',
